...
import 'package:parkwell/constant/collection_name.dart';
import 'package:parkwell/constant/constant.dart';
import 'package:parkwell/model/admin_commission.dart';
import 'package:parkwell/model/bank_details_model.dart';
import 'package:parkwell/model/coupon_model.dart';
import 'package:parkwell/model/faq_model.dart';
import 'package:parkwell/model/language_model.dart';
import 'package:parkwell/model/on_boarding_model.dart';
import 'package:parkwell/model/order_model.dart';
import 'package:parkwell/model/parking_model.dart';
import 'package:parkwell/model/payment_method_model.dart';
import 'package:parkwell/model/referral_model.dart';
import 'package:parkwell/model/review_model.dart';
import 'package:parkwell/model/tax_model.dart';
import 'package:parkwell/model/user_model.dart';
import 'package:parkwell/model/user_vehicle_model.dart';
import 'package:parkwell/model/vehicle_brand_model.dart';
import 'package:parkwell/model/vehicle_model.dart';
  ...
  getSettings() async {
    ...
    await fireStore
      ...
      if (value.exists) {
        ...
        Constant.insuranceFee = double.parse(value.data()!["insurance_fee"]);
        Constant.serviceFee = double.parse(value.data()!["service_fee"]);
