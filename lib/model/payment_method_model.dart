class PaymentModel {
  ...
  PaymentModel.fromJson(Map<String, dynamic> json) {
    ...
    paywell = json['paywell'] != null ? Paywell.fromJson(json['paywell']) : null;
...
class Paywell {
  ...
  Paywell({this.image, this.vendor_key, this.enable, this.name});

  Paywell.fromJson(Map<String, dynamic> json) {
    image = json['image'];
    vendor_key = json['vendor_key'];
    enable = json['enable'];
    name = json['name'];
  }
