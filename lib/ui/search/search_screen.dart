...
import 'package:parkwell/controller/search_controller.dart';
import 'package:parkwell/model/location_lat_lng.dart';
...
import 'package:parkwell/ui/parking_details_screen/parking_details_screen.dart';
...
import 'package:parkwell/utils/utils.dart';
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          InkWell(
                                                              ...
                                                              child: Icon(
                                                                  parkingModel.bookmarkedUser!.contains(FireStoreUtils
                                                                              .getCurrentUid()) &&
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Row(
                                                            children: [
                                                              SvgPicture.asset(
                                                                  parkingModel.parkingType ==
                                                                          "2"
                                                                      ? "assets/icon/ic_bike.svg"
                                                                      : "assets/icon/ic_car_fill.svg",
                                                                  color: AppThemData
                                                                      .blueLight07),
                                                              Text(
                                                                " ${parkingModel.parkingType.toString()} wheel"
                                                                    .tr,
                                                                maxLines: 1,
                                                                style:
                                                                    const TextStyle(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              color: controller.selectedSortBy.value == "distance".tr ? AppThemData.white : AppThemData.grey07,
                                              fontSize: 14,
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              color: controller.selectedSortBy.value == "lower_price".tr ? AppThemData.white : AppThemData.grey07,
                                              fontSize: 14,
                                              fontFamily: AppThemData.regular,
                                            ),
                                          ),
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              color: controller.selectedSortBy.value == "higher_price".tr ? AppThemData.white : AppThemData.grey07,
                                              fontSize: 14,
                                            ),
                                          ),
                                        ),
                                    ...
                                    ? Column(
                                        ...
                                        children: [
                                          ...
                                          Slider(
                                            ...
                                            divisions: 24,
                                            label:
                                                "${controller.selectedKm.value.round().toString()} KM",
                                          ),
                                        ],
                                      )
                                    : Container()
