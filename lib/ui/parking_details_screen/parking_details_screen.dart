...
import 'package:parkwell/controller/parking_details_controller.dart';
import 'package:parkwell/model/parking_facilities_model.dart';
...
import 'package:parkwell/ui/booking_process/booking_parking_details_screen.dart';
import 'package:parkwell/ui/chat/chat_screen.dart';
...
class ParkingDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<ParkingDetailsController>(
        ...
        builder: (controller) {
          return Scaffold(
            appBar: UiInterface()
                .customAppBar(context, themeChange, "parking_details".tr),
                        ...
                        children: [
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: NetworkImageWidget(
                                  imageUrl: controller.parkingModel.value.image
                                      .toString(),
                                  height: 180,
                                  width: Get.width,
                                  fit: BoxFit.cover,
                                ...
                                child: InkWell(
                                    onTap: () async {
                                      ShowToastDialog.showLoader(
                                          "Please wait..".tr);
                                      if (controller
                                          .parkingModel.value.bookmarkedUser!
                                          .contains(
                                              FireStoreUtils.getCurrentUid())) {
                                        await FireStoreUtils.removeBookMarked(
                                                controller.parkingModel.value)
                                            .then((value) {
                                          controller.getData();
                                          ShowToastDialog.closeLoader();
                                        });
                                      } else {
                                        await FireStoreUtils.bookMarked(
                                                controller.parkingModel.value)
                                            .then((value) {
                                          controller.getData();
                                          ShowToastDialog.closeLoader();
                                  ...
                                  onTap: () async {
                                    ...
                                    UserModel? userModel =
                                        await FireStoreUtils.getUserProfile(
                                            controller.parkingModel.value.userId
                                                .toString());
                                    ShowToastDialog.closeLoader();
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              ...
                              children: [
                                boxDecoration(
                                    "${controller.parkingModel.value.parkingSpace.toString()} Spots"
                                        .tr,
                                    themeChange,
                                    Icons.local_parking),
                                const SizedBox(
                                ...
                                boxDecoration(controller.distance.value,
                                    themeChange, Icons.location_on),
                                const SizedBox(
                                  width: 10,
                                ),
                                boxDecoration(controller.duration.value,
                                    themeChange, Icons.access_time_outlined),
                              ],
                            ),
                          ),
                          const SizedBox(
                          ...
                          Text(
                            controller.parkingModel.value.description
                                .toString(),
                            style: TextStyle(
                              fontSize: 14,
                          ...
                          Wrap(
                            ...
                            children: List<Widget>.generate(
                                controller.parkingModel.value.facilities!
                                    .length, (int index) {
                              ParkingFacilitiesModel parkingFacility =
                                  controller
                                      .parkingModel.value.facilities![index];
                              return Padding(
                                padding:
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    NetworkImageWidget(
                                      imageUrl:
                                          parkingFacility.image.toString(),
                                      height: 20,
                                      width: 20,
                                      fit: BoxFit.fill,
                                    ),
            ...
            bottomNavigationBar: Padding(
              ...
              child: Container(
                ...
                child: RoundedButtonFill(
                  ...
                  fontSizes: 12,
                  onPress: () {
                    if (controller.parkingModel.value.userId ==
                        FireStoreUtils.getCurrentUid()) {
                      ShowToastDialog.showToast(
                          "You can't book your own parking.");
                    } else {
                      Get.to(() => const BookingParkingDetailsScreen(),
                          arguments: {
                            "parkingModel": controller.parkingModel.value
                          });
                    }
                  },
                ),
  ...
  Widget boxDecoration(String title, themeChange, IconData? image) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(5), color: AppThemData.primary03),
      child: Center(
        child: Row(
          mainAxisSize: MainAxisSize.min,
