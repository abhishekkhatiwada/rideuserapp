...
import 'package:parkwell/controller/wallet_controller.dart';
import 'package:parkwell/model/wallet_transaction_model.dart';
import 'package:parkwell/model/withdraw_model.dart';
...
import 'package:parkwell/themes/text_field_widget.dart';
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                Constant.amountShowInReadAbleFormate(amount: controller.userModel.value.walletAmount),
                        ...
                        child: RoundedButtonFill(
                          ...
                          onPress: () {
                            if (controller
                              ...
                              Get.back();
                              double withoutServiceFee=double.parse(controller.amountController.value.text);
                              String TopupAmount=((withoutServiceFee+Constant.serviceFee).round()).toString();
                              if (double.parse(controller.amountController.value.text) >= double.parse(Constant.minimumAmountToDeposit.toString())) {
                                if (controller.selectedPaymentMethod.value == controller.paymentModel.value.paywell!.name) {
                                  controller.processPaywellPayment(amount: TopupAmount,title: 'Payment For Wallet Topup',description: 'Payment For Wallet Topup');
                                }else if (controller.selectedPaymentMethod.value == controller.paymentModel.value.strip!.name) {
                                  controller.stripeMakePayment(amount: TopupAmount);
                                  ...
                                  RazorPayController()
                                    ...
                                    if (value == null) {
                                      ...
                                      controller.openCheckout(amount: TopupAmount, orderId: result.id);
                                    }
                                  });
                                } else {
                                  ShowToastDialog.showToast(
    ...
    return Column(
      children: [
        ...
        Divider(
            thickness: 1,
            color:
                themeChange.getThem() ? AppThemData.white : AppThemData.grey11),
      ],
    );
  }
