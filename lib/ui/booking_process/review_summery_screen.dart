...
import 'package:parkwell/controller/review_summary_controller.dart';
...
import 'package:parkwell/ui/booking_process/payment_select_screen.dart';
import 'package:parkwell/ui/chat/chat_screen.dart';
import 'package:parkwell/ui/live_tracking_screen/live_tracking_screen.dart';
import 'package:parkwell/ui/review/review_screen.dart';
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        Constant.amountShow(amount: Constant.serviceFee.toString()),
                                        style: TextStyle(
                                          color: themeChange.getThem() ? AppThemData.grey03 : AppThemData.grey07,
                                          fontSize: 16,
                                          fontFamily: AppThemData.semiBold,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        Constant.amountShow(amount: Constant.insuranceFee.toString()),
                                        style: TextStyle(
                                          color: themeChange.getThem() ? AppThemData.grey03 : AppThemData.grey07,
                                          fontSize: 16,
                                          fontFamily: AppThemData.semiBold,
