...
class Constant {
  ...
  static String mapAPIKey = "AIzaSyAkZRcN1hMSzExSEALiKkltxLDYlQfqqPU";
  ...
  static double insuranceFee=0.0;
  static double serviceFee=0.0;
  ...
  static const globalUrl = "https://parkwell.testserverstudio.tech/";
  ...
  static String amountShowInReadAbleFormate({required String? amount}) {
      double parsedAmount = double.parse(amount ?? '0');
      MoneyFormatterOutput fmf = MoneyFormatter(
          amount: parsedAmount,
          settings: MoneyFormatterSettings(
            symbol: Constant.currencyModel!.symbol.toString(),
          )
      ).output;
      if (Constant.currencyModel!.symbolAtRight == true) {
        return fmf.compactSymbolOnRight;
      }else{
        return fmf.compactSymbolOnLeft;
      }
    }
